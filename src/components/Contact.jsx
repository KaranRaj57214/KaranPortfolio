...
import { FaDribbble, FaEnvelope, FaGithub, FaMapMarkerAlt, FaPhone } from 'react-icons/fa'
                    ...
                    <div>
                        <form className='space-y-6' >
                            ...
                            <div>
                                ...
                                <textarea className='w-full h-40 bg-dark-300 border border-dark-400 rounded-lg px-4 py-3 outline-none' type='mesaage' />  
                            </div>
                    ...
                    <div className='space-y-8 '>
                        <div className='flex items-start'>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-400'>Ajronda,Faridabad,Haryana</p>
                                </div>
                        </div>
                        ...
                        <div className='flex items-start'>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-400'>karan8799742199@gmail.com</p>
                                </div>
                        </div>
                        ...
                        <div className='flex items-start'>
                                ...
                                <div>
                                    ...
                                    <p className='text-gray-400'>+91 8130489093</p>
                                </div>
                        </div>
